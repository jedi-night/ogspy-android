...
public class SpysUtils {
     ...
     */
    public static void showSpys(ServerHelper serverHelper, SpysHelper spysHelper) {
        if (serverHelper != null) {
            OgspyActivity.mServerName = serverHelper.getServerName();
        }
        ...
        if (spysHelper != null) {
            ...
            if (spysHelper.getMostCuriousPlayers().size() > 0) {
                ...
                final GeneralSpyListAdapter adapterPlayer = new GeneralSpyListAdapter(OgspyApplication.getContext(), spysPlayer);
                ...
                listPlayers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> adapter, View v, int position, long arg3) {
                        ...
                        Intent dialog = new Intent(OgspyApplication.getContext(), DialogHighscores.class);
                        ...
                        OgspyApplication.getContext().startActivity(dialog);
                    }
                });
                /*listPlayers.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    @Override
                ...
                listPlayers.setAdapter(new ArrayAdapter<>(OgspyApplication.getContext(), android.R.layout.simple_list_item_1, noPlayerSpys));
            }
            ...
            if (spysHelper.getMostCuriousAlliances().size() > 0) {
                ...
                final GeneralSpyListAdapter adapterAlly = new GeneralSpyListAdapter(OgspyApplication.getContext(), spysAlly);
                ...
                listAlliances.setAdapter(new ArrayAdapter<>(OgspyApplication.getContext(), android.R.layout.simple_list_item_1, noAllySpys));
            }
        }
    }
}
