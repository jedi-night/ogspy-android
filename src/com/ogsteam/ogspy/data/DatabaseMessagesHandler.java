...
public class DatabaseMessagesHandler extends DatabaseHandler {
	...
	public Message getMessageById(int id) {
        ...
        Message message = new Message(Integer.parseInt(cursor.getString(0)), cursor.getInt(1), cursor.getString(2), cursor.getString(3));
	    return message;
	}
	...
	public List<Message> getAllMessages() {
	    ...
	    if (cursor.moveToFirst()) {
	        do {
                ...
                message.setDatetime(cursor.getInt(1));
